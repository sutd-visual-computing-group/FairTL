...
from dataset_splits import (
    ...
    build_60_40_unbalanced_datasets_clf_celeba,
    build_75_25_unbalanced_datasets_clf_celeba,
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--dataset', type=str, help='celeba, UTKFace, or FairFace', default="celeba")
    # parser.add_argument('--model_name', type=str, help='ResNet18, CNN5, or CNN3', default="ResNet18")
    ...
    parser.add_argument('--bias', type=str, default='60_40',
    ...
    if args.dataset == 'celeba':
        ...
        elif args.bias == '75_25':
            balanced_train_dataset, unbalanced_train_dataset = build_75_25_unbalanced_datasets_clf_celeba(
                args.dataset, 'train', args.perc)
            balanced_valid_dataset, unbalanced_valid_dataset = build_75_25_unbalanced_datasets_clf_celeba(
                args.dataset, 'val', args.perc)
            bias = '75_25_perc{}'.format(args.perc)
        elif args.bias == '60_40':
            balanced_train_dataset, unbalanced_train_dataset = build_60_40_unbalanced_datasets_clf_celeba(
                args.dataset, 'train', args.perc)
            balanced_valid_dataset, unbalanced_valid_dataset = build_60_40_unbalanced_datasets_clf_celeba(
                args.dataset, 'val', args.perc)
            bias = '60_40_perc{}'.format(args.perc)
